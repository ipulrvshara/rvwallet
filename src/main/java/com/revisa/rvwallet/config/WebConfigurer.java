package com.revisa.rvwallet.config;
...
import com.revisa.rvwallet.web.filter.CachingHttpHeadersFilter;
import com.revisa.rvwallet.web.filter.StaticResourcesProductionFilter;
import com.revisa.rvwallet.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "rvwallet");
